process KALLISTO_QUANT {
    ...
    tuple val(meta), path("${prefix}/pseudoalignments.bam")     , emit: bam
    tuple val(meta), path("${prefix}/pseudoalignments.bam.bai") , emit: bai
    ...
    script:
    def args = task.ext.args ?: params.extra_kallisto_quant_args ?: ''
